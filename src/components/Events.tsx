        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {events.map((event) => (
            ...
            >
              ...
              <button className="mt-4 w-full bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-indigo-500/25">
                View Details
              </button>
            </div>
          ))}
